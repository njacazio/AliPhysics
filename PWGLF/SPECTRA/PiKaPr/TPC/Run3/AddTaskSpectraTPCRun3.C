AliAnalysisTaskSpectraTPCRun3* AddTaskSpectraTPCRun3(Bool_t mc = kFALSE, Bool_t aod = kTRUE, Bool_t o2pid = kTRUE, Bool_t trackcuts = kTRUE)
{
  ...
  AliAnalysisTaskSpectraTPCRun3* task = new AliAnalysisTaskSpectraTPCRun3("SpectraTPCRun3", aod, o2pid, trackcuts);
